...
<body>
    <nav class="top-bar titlebar" data-topbar role="navigation">
        ...
        <div class="top-bar-section">
            <ul class="right">
                <li>
                    <a target="_blank" href="https://plus.google.com/+TuyanoSYOTA">about</a>
                </li>
            </ul>
        </div>
    </nav>
    ...
    <div class="container clearfix">
        ...
        <nav class="large-2 mudium-3 columns sidebar" id="actions-sidebar">
            <ul class="side-nav">
                <li class="heading"><?= __('Auctoins') ?></li>
